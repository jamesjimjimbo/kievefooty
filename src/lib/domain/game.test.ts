...
it("auto-picks the GOTW draw and first listed home team at five",()=>expect(createAutoPicks(fixtures)).toEqual([{fixtureId:"ars-liv",outcome:"draw",stake:5,source:"auto"},{fixtureId:"bha-che",outcome:"home",stake:5,source:"auto"}]));
