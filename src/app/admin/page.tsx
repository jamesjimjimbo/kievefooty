...
import { CalendarCog, ClipboardList, Coins, Gauge, Swords, UsersRound } from "lucide-react";
import { AppShell } from "@/components/app-shell";
import { createClient } from "@/lib/supabase/server";
import { setGameOfWeek, syncLockToFirstKickoff, toggleFixtureEligibility } from "./actions";
...
export default async function Page(){
  ...
  const [{data:weekData},{count:ledger},{count:challenges},{count:players},{count:submitted}]=await Promise.all([
